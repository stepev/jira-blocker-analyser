...
* Категорию блокировки
	* Скрипт ищет в комментарии текст обрамлённый фигурными скобками {} и считает текст в скобках меткой категории. При установке флага, добавляя в комментарий тег причины блокировки, вы облегчите себе кластеризацию блокировок
